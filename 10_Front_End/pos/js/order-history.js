// =============================================
//  order-history.js  —  FIXED
//  Bugs fixed:
//  1. Unwrap APIResponse .data in ALL ajax calls
//  2. orderId is Integer → use String() before toLowerCase()
//  3. filterByCustomer response also wrapped
// =============================================
